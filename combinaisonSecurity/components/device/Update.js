...
import { success } from '../../actions/device/create';
import { retrieve, update, reset } from '../../actions/device/update';
import { loading, error } from '../../actions/device/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.device.update.retrieveError,
  retrieveLoading: state.device.update.retrieveLoading,
  updateError: state.device.update.updateError,
  updateLoading: state.device.update.updateLoading,
  created: state.device.create.created,
  deleted: state.device.del.deleted,
  retrieved: state.device.update.retrieved,
  updated: state.device.update.updated,
});
