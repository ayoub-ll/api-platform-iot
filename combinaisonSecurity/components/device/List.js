...
import { list, reset } from '../../actions/device/list';
import { success } from '../../actions/device/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>macAddress: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['macAddress']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>coordinator: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['coordinator']}</Text>
                </View>
              </View>
            }
        />
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.device.list;
