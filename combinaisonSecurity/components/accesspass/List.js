...
import { list, reset } from '../../actions/accesspass/list';
import { success } from '../../actions/accesspass/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>pass: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['pass']}</Text>
                </View>
              </View>
            }
        />
